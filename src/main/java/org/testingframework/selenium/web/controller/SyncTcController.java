...
@Controller
public class SyncTcController {

	@Autowired
	private UserService userService = null;
		
	@RequestMapping(value="/synctc", method = RequestMethod.GET)
    public String displaySyncTCPage(ModelMap model) {
	...
	@RequestMapping(value="/synctc", method = RequestMethod.POST)
    public String syncTc(ModelMap model) {
